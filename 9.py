...
plt.pie(result_counts, labels=result_df['Experiment'], autopct='%1.1f%%', colors=['#ff6666', '#66b3ff', '#99ff99'], startangle=90)
plt.title('WEB', fontweight='bold')
plt.legend(result_counts.index, title="Results", loc="center right", labels=["Pass", "Fail"])
